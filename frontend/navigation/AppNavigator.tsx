  ...
  export type RootStackParamList = {
    ...
    BasicInfo: undefined;
    Pregnant: { basicInfo: CustomFormData };
    Pressure: { basicInfo: CustomFormData, pregnant: string };
    PainArea: { basicInfo: CustomFormData, pregnant: string, pressurePreference: string };
  };
